        ...
        <>
          ...
          >
            <div data-lenis-prevent="true" className="relative w-full max-w-5xl max-h-[90vh] overflow-y-auto pointer-events-auto bg-[#0a0d14] border border-white/10 rounded-2xl shadow-[0_0_80px_rgba(37,99,235,0.15)] text-white">
              ...
              {/* Header */}
              <div className="sticky top-0 z-10 bg-[#0a0d14] border-b border-white/8 px-6 py-5 flex items-start sm:items-center justify-between gap-4">
                <div>
              ...
              <div className="p-6">
                ...
                <div className="mt-8 pt-6 border-t border-white/10 flex justify-center">
                  <a
                    ...
                    className="inline-flex items-center justify-center gap-2 px-10 py-4 rounded-full bg-blue-600 hover:bg-blue-500 text-white font-semibold text-lg transition-all shadow-[0_0_30px_rgba(37,99,235,0.4)] hover:shadow-[0_0_40px_rgba(37,99,235,0.6)] hover:scale-105 active:scale-95"
                    onClick={onClose}
                  >
